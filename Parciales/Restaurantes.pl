...
% El menú por pasos, diseñado por un chef en conjunto con un sommelier de vino, consta de un número determinado de platos, un precio, una lista de vinos y una cantidad estimada de comensales que comparte el menú. 
...
% Punto 3: Si un restaurante está mal organizado, que es cuando tiene algún menú que tiene más pasos que la cantidad de vinos disponibles o cuando tiene en su menú a la carta dos veces una misma comida con diferente precio.
...
% Punto 4: Qué restaurante es copia barata de qué otro restaurante, lo que sucede cuando el primero tiene todos los platos a la carta que ofrece el otro restaurante, pero a un precio menor. Además, no puede tener más estrellas que el otro. 
...
% En los menú por pasos, el precio es el indicado más la suma de los precios de todos los vinos incluidos, pero dividido en la cantidad de % % comensales. Los vinos importados pagan una tasa aduanera del 35% por sobre su precio publicado.
